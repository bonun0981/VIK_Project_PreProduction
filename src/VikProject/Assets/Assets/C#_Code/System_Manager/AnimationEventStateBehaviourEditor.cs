...
[UnityEditor.CustomEditor(typeof(PlayeAnimationEventStateMachine))]
...
public override void OnInspectorGUI()
{
    ...
    PlayeAnimationEventStateMachine stateBehaviour = (PlayeAnimationEventStateMachine)target;
...
void PreviewAnimationClip(PlayeAnimationEventStateMachine stateBehaviour)
{
...
void SampleBlendTreeAnimation(PlayeAnimationEventStateMachine stateBehaviour, float normalizedTime)
{
...
ChildAnimatorState FindMatchingState(AnimatorStateMachine stateMachine, PlayeAnimationEventStateMachine stateBehaviour)
{
...
bool Validate(PlayeAnimationEventStateMachine stateBehaviour, out string errorMessage)
{
